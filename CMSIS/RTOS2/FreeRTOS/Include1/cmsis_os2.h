...
#define osThreadZone(n) ((((n) << osThreadZone_Pos) & osThreadZone_Msk) | osThreadZone_Valid)  ///< MPU protected zone
...
#define osSafetyClass(n) ((((n) << osSafetyClass_Pos) & osSafetyClass_Msk) | osSafetyClass_Valid)  ///< Safety class
...
/// \param[in]     ticks         \ref kernelTimer "time ticks" value until the thread watchdog expires, or 0 to stop the
/// watchdog \return status code that indicates the execution status of the function.
